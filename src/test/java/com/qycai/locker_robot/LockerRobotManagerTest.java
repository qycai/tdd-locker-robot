...
public class LockerRobotManagerTest {
    ...
    @Test
    void should_return_ticket_when_save_M_bag_given_manager_manage_locker1_primaryLockerRobot_with_locker2_superLockerRobot_with_locker3_and_all_lockers_have_capacity() throws LockerTypeMismatchWithRobot, LockerIsFullException, TicketIsInvalidException {
        Locker locker1 = new Locker(3, "S");
        Locker locker2 = new Locker(4, "M");
        Locker locker3 = new Locker(9, "L");
        PrimaryLockerRobot primaryLockerRobot = new PrimaryLockerRobot(Collections.singletonList(locker2));
